...
async def get_tasks_ordered_by_deadline(list_id: str):
...
async def get_task(list_id: str, task_id: str):
...
async def add_task(list_id: str, task: TaskCreate):
...
async def update_task(list_id: str, task_id: str, task: TaskUpdate):
    """Update a task"""
...
async def toggle_task_completion(list_id: str, task_id: str):
